                ...
                <nav className="border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className="flex items-center lg:order-2">
                            <button data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"  onClick={() => setHiddenDropdownInformation(prev => !prev)} aria-controls="mobile-menu-2" aria-expanded="false">
                        ...
                        <div className={`${!hiddenDropdownInformation ? 'hidden' : 'fixed w-full px-1 pb-2 top-[60px] left-0 bg-gradient-to-r from-[#00C5EF] to-[#0092f4] z-[1000000]'} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`} id="mobile-menu-2">
                            ...
                            <div className="relative">
                                ...
                                <div id="dropdownInformation" className={`${!hiddenDropdownInformation && 'hidden'} fixed -translate-x-[5%] xl:-translate-x-[0%] 2xl:-translate-x-2/3 z-50 bg-white lg:right-8 divide-y divide-gray-100 rounded-lg shadow w-52 dark:bg-gray-700 dark:divide-gray-600`}>
                                    ...
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
                                        <li>
                                            <button className="block px-4 py-2 w-full text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => setShowModal(true)}>Change Password</button>
                                        </li>
                                        <li>
